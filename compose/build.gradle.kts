...
dependencies {
    ...
    api("androidx.compose.ui:ui:1.2.0-alpha08")
    api("androidx.compose.material:material:1.2.0-alpha08")
    api("androidx.compose.foundation:foundation:1.2.0-alpha08")
    api("androidx.compose.material:material-icons-core:1.2.0-alpha08")
    api("androidx.compose.material:material-icons-extended:1.2.0-alpha08")
